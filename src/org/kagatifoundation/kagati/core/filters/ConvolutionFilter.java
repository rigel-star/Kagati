...
package org.kagatifoundation.kagati.core.filters;

import java.awt.image.BufferedImage;
import java.awt.image.Kernel;

import org.kagatifoundation.kagati.core.ImageFilter;
import org.kagatifoundation.kagati.core.ImageMath;
...
public abstract class ConvolutionFilter implements ImageFilter {
	...
	public BufferedImage apply(BufferedImage source) {
		...
		source.getRGB(0, 0, width, height, data, 0, width);
		...
		outputImage.setRGB(0, 0, width, height, out, 0, width);
	 ...
	 * */
	private static int constrain(int pix, int min, int max) {
