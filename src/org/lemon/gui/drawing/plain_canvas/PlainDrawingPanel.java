package org.lemon.gui.drawing.plain_canvas;
...
public class PlainDrawingPanel extends JInternalFrame implements ActionListener {

	private static final long serialVersionUID = 1L;

	private PlainDrawingCanvas drawPanel;
	...
	public PlainDrawingPanel(String title, int w, int h) {
		...
		drawPanel = new PlainDrawingCanvas(this.colorsMap.get(this.colors.getSelectedItem()),
