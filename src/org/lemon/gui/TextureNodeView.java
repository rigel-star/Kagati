...
public class TextureNodeView extends NodeView {
	...
	public TextureNodeView() {
		...
		c.add(txtrHolder, BorderLayout.NORTH);
		c.add(blendComboPan, BorderLayout.CENTER);
		c.add(sliderContainer, BorderLayout.SOUTH);
	}
