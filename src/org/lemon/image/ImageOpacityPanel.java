...
public class ImageOpacityPanel extends JPanel implements ChangeListener {
	...
	public ImageOpacityPanel(BufferedImage img, ImageView imgView) {
		this.img = img;
	...
	public void stateChanged(ChangeEvent e) {
		if(e.getSource() == this.opacity) {
			...
			new Opacity(this.imgView, img, (float) op);
		}
	}
