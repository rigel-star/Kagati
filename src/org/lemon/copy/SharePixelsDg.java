...
public class SharePixelsDg extends JWindow implements  MouseMotionListener, ChangeListener, ActionListener {
	...
	public SharePixelsDg(BufferedImage img, BufferedImage img2) {
		int h = img.getHeight();
		int w = img.getWidth();
		this.copy = img2;
		this.original = img;
